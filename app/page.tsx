...
/** Российские дворы подгружаются из /data/mints.json (с логотипами); зарубежные — FOREIGN_MINT_CARD_LIST (как в lib/mintLogoLookup). */
const foreignMints = FOREIGN_MINT_CARD_LIST;
