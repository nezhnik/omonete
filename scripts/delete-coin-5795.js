/**
 * Удаляет сет монет "Sovereigns" id=5795 из БД и каталога.
 * Запуск: node scripts/delete-coin-5795.js
 */
...
async function main() {
  ...
  console.log("Дальше: node scripts/set-sovereigns-series.js && npm run data:export:incremental && npm run build");
}
